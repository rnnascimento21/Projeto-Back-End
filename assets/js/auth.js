...
if (toggleBtn && submitBtn && nameField) {
...
if (authForm) {
  authForm.addEventListener("submit", async (event) => {
    ...
    const isCadastro = nameField && !nameField.classList.contains("hidden");
...
function configurarBotaoAutenticacao() {
  // Esta função agora é gerenciada pelo user-panel.js
